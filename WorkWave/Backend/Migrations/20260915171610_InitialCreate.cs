        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicantEmail = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    CoverLetter = table.Column<string>(type: "text", nullable: false),
                    ResumeFileName = table.Column<string>(type: "character varying(260)", maxLength: 260, nullable: true),
                    ResumeOriginalFileName = table.Column<string>(type: "character varying(260)", maxLength: 260, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "EmailVerificationToken", "EmailVerificationTokenExpiresAt", "FullName", "IsEmailVerified", "PasswordHash", "Role" },
                values: new object[] { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@workwave.com", null, null, "WorkWave Admin", true, "100000.DC1OA2PJBVgR8D+W3glHhQ==.UpIuy2g6O9F7r5IGi31XJmw4FAEr/EZIoZYVmTgPBZg=", "Admin" });
